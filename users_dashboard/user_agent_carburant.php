...
// Vérifier si l'utilisateur a le rôle '5' (Agent Carburant)
if ($_SESSION['role'] != 5) {
...
<head>
    ...
    <title>Dashboard Agent Carburant</title>
    <link rel="stylesheet" type="text/css" href="../css/styles_agent_carburant.css">
