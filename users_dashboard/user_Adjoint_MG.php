...
if ($_SESSION['role'] != 2) { // Rôle de l'utilisateur Adjoint_MG
...
// Requête pour des notifications spécifiques à l'utilisateur d'achat
$sql = "SELECT COUNT(*) AS notification_count FROM expression_besoins  WHERE notified = 0";
...
<head>
    ...
    <title>Adjoint Moyen Géneraux Dashboard</title>
